...
pars = {'D':38., 'alph':0.1, 'alph_s':0.06, 'rNH':0.17, 'beta':0.018, 'rHR':0.02, 'conv':0.04, 'rHR2':0.02} 
pars.update({'b':0.18})
pars.update({'ttreat':5.5, 'ttreat_dl':0.05, 'twash':6., 'twash_dl':0.05})
...
fitpars = {}
fixpars = {} 
fitpars_nm = ['alph_s', 'rNH', 'beta', 'conv']
