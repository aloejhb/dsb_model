...
'''
pars = {'D':2., 'alph':0.8, 'alph_s':0.42, 'rNH':0.052, 'dp':0.12, 'beta':0.02, 'rHR':0.02, 'conv':0.024, 'rHR2':0.02} 
pars.update({'b':0.18})
pars.update({'ttreat':2., 'ttreat_dl':0.05, 'twash':22., 'twash_dl':0.05})
pars.update({'ts':6., 'ts_dl':1., 'tg2':20., 'tg2_dl':2.} )
'''
pars = {'D':4.86, 'alph':1.452, 'alph_s':0.036, 'rNH':0.052, 'dp':0.12, 'beta':0.2, 'rHR':0.02, 'conv':0.024, 'rHR2':0.02} 
pars.update({'b':0.18})
pars.update({'ttreat':1.9, 'ttreat_dl':0.05, 'twash':22., 'twash_dl':1.})
pars.update({'ts':3.4, 'ts_dl':2., 'tg2':17.54, 'tg2_dl':50.} )
