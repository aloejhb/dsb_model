...
pars = {'D':35., 'alph':0.9, 'alph2':0.9, 'beta':0, 'beta2':0.03, 'rNH':0.13, 'rHR':0.2, 'rHR2':0.06, 'conv':0, 'conv2':1.} 
pars.update({'dp':0, 'dp2':0.32, 'dp_5r':0, 'dp2_5r':0.32})
pars.update({'b':0.45})
pars.update({'ttreat':5., 'ttreat_dl':0.05, 'twash':5.7, 'twash_dl':0.05, 'ts':7., 'ts_dl':0.2, 'tg2':13., 'tg2_dl':0.2})
