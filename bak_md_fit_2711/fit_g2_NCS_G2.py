...
# pars = {'D':13., 'alph2':0.8, 'beta2':0.01, 'rNH':0.13, 'rHR':0.2, 'rHR2':0.05, 'conv2':1.} 
pars = {'D':20., 'alph2':0.8, 'beta2':0.05, 'rNH':0.13, 'rHR':0.06, 'rHR2':0.06, 'conv2':1.} 
pars.update({'b':0.45})
...
par_grid = [('alph2',linspace(0.001, 1., 30)), ('beta2',linspace(0.001, 1., 30))]
