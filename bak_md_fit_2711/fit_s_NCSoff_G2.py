...
pars = {'D':60., 'alph':0.1, 'alph2':0.1, 'beta':0, 'beta2':0.1, 'rNH':0.25, 'rHR':0.08, 'rHR2':0.08, 'conv':0, 'conv2':1.} 
pars.update({'dp':0, 'dp2':0.32, 'dp_5r':0, 'dp2_5r':0.32})
pars.update({'b':0.45})
pars.update({'ttreat':5., 'ttreat_dl':0.05, 'twash':5.7, 'twash_dl':0.05, 'ts':8.5, 'ts_dl':0.2, 'tg2':11.5, 'tg2_dl':0.2})
