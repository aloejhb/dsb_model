...
pars = {'D':1.16, 'b':0.45, 'alph':10., 'beta':0.001, 'rNH':0.0001, 'rNHup':0.2, 'rHR':0.001, 'ttreat':2., 'ttreat_dl':0.15, 'twash':22., 'twash_dl':7.3, 'treg':4., 'treg_dl':7.2}
...
model = Model(mdname, x0, stoich, ttime, mk_pfuncs, pars, xname, xcolor, detxcolor, pname, pcolor, obsinds, obsname, obscolor, detobscolor, fuzz, pfunc_typ)
...
md_pars['NCS_G1s']= {'D':30., 'b':0.45, 'alph':0.6, 'beta':0.001, 'rNH':0.15, 'rNHup':0.1, 'rHR':0.001, 'ttreat':5., 'twash':5.6, 'treg':98.}
model_list['NCS_G1s'].setAllPars(md_pars['NCS_G1s'])

model_list['basal'] = copy.deepcopy(model)
md_pars['basal']= {'D':0.45, 'b':0.45, 'alph':0.6, 'beta':0.001, 'rNH':0.15, 'rNHup':0.1, 'rHR':0.001, 'ttreat':5., 'twash':7.5, 'treg':98.,}
...
# Doxo data fitting 
fixpars['G1G1_Doxo'] = {'b':0.45, 'beta':0.001, 'ttreat':2., 'rHR':0.001, 'twash':22.}
fitpars['G1G1_Doxo'] = {'D':2., 'alph':4., 'rNH':0.15, 'rNHup':0.3, 'ttreat_dl':0.15, 'twash_dl':4.8, 'treg':2.5, 'treg_dl':11.}
