...
def mk_pfuncs(p):
    ...
    pfuncs.append(step_pfunc((p['rHR'],), (), mk_hfunc((3,)) ))
...
pars = {'D':6., 'b':1., 'alph2':0.4, 'beta2':0.8, 'rNH':0.5, 'rHR':0.4, 'conv2':0.4, 'ttreat':1., 'ttreat_dl':0.5, 'twash':22., 'twash_dl':10.}
...
md_pars['NCS_G2G1s'] = {'D':50., 'b':0.45, 'alph2':0.6, 'beta2':0.2, 'rNH':0.15, 'rHR':0.08, 'conv2':2., 'ttreat':5., 'twash':5.6 }
model_list['NCS_G2G1s'].setAllPars(md_pars['NCS_G2G1s'])

model_list['NCS_G2G2s'] = copy.deepcopy(model)
md_pars['NCS_G2G2s'] = {'D':50., 'b':0.45, 'alph2':0.6, 'beta2':0.2, 'rNH':0.15, 'rHR':0.055, 'conv2':2., 'ttreat':5., 'twash':5.6 }
